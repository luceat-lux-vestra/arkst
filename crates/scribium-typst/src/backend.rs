...
use scribium_core::source::VirtualPathBuf;
...
pub struct TypstInput {
    ...
    ///
    /// The path is validated and normalized through `VirtualPathBuf` before
    /// subprocess execution. It is never interpreted as a host absolute path.
