use arkst_markdown::{parse_with_mode, Block, Mode};

fn root_raw_body(source: &str) -> arkst_markdown::ast::RawBody {
...
fn raw_source(raw_body: &arkst_markdown::ast::RawBody) -> &str {
    raw_body
        .source
        .slice(raw_body.span)
