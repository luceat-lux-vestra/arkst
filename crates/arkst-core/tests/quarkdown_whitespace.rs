...
use arkst_core::ir::{IrInline, IrNode, IrSize, IrSizeUnit, IrValue};
...
fn whitespace(result: &arkst_core::CompileResult) -> &IrInline {
...
fn whitespace_rejects_inline_and_lambda_bodies() {
    ...
    let inline_document = arkst_core::ir::IrDocument {
    ...
    let lambda_document = arkst_core::ir::IrDocument {
        nodes: vec![IrNode::FunctionCall {
            name: "whitespace".to_string(),
            positional_args: Vec::new(),
            named_args: Vec::new(),
