use arkst_core::ir::{IrInline, IrNode, NativeTarget};
use arkst_core::{
...
fn project_for(source: &str) -> arkst_core::VirtualProject {
...
fn target_block(node: &IrNode) -> (&str, arkst_core::SourceSpan) {
