//! IR (Intermediate Representation) — Arkst's one backend-neutral document model.
//!
...
/// serializable for `arkst inspect --emit ir` output. Its JSON form stores
...
mod tests {
    ...
    fn standalone_raw_body_preserves_a_real_marker_looking_source() {
        let source = "\0arkst-source-ref:17";
