...
> Quarkdown compatibility is partial and evidence-based. The current verified baseline is referenced against Quarkdown v2.6.0 under [`docs/compatibility/quarkdown/`](docs/compatibility/quarkdown/).
>
