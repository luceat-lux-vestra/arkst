...
v2.5.1/v2.6.0 artifacts. Arkst now models that bounded contract with a backend-neutral error
component and native-build continuation. #197 stays open for strict-mode behavior,
