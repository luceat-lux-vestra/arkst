...
documentation overclaim. The lexical gaps in [#157], [#158], [#159], and
[#160] are now implemented at the grammar/frontend boundary below; the
remaining bounded issues are [#162] and [#164], both native sub-issues of
#148:
...
- `docs/SYNTAX.md` now records the pinned call-identifier, numeric-reference,
  ...
  contract, while retaining separate notes for the remaining #162 and #164
  gaps. The #159 recovery and #160 content-inline frontend slices are recorded
  in the matrix.
...
- The remaining production gaps are tracked as #162 and #164; #159's bounded
  parser/frontend recovery and #160's bounded content-inline slice are
  implemented, while broader content conversion remains separately owned. No
  gap is hidden with expected-failure tests or compatibility allowlists in this
  audit.
