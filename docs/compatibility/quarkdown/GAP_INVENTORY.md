...
- **Scribium comparison head:** `5a5bea58c6e35b45a2baefd481a411c46ac3ea03`
...
|---|---|
| Compatible at the stated bounded boundary | Logical and comparison operations; project-backed `.read`, `.json`, and `.include` |
...
| Intentionally deferred | Unimplemented data-loading families, `.llmstxt`, function-driven metadata, layout/components, comparator-language sorting, and generalized DynamicValue conversion |
