...
- claim Quarkdown source-echo rendering, still-unevidenced output contexts, or JVM strict stack-frame parity; exact HTML/CSS styling is not a Typst/PDF closure requirement;
...
- close #197 while source-echo/still-unevidenced output contexts and remaining logger String categories such as Collection remain;
