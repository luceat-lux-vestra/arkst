...
- claim logger String formatting beyond the independently evidenced Unit/None/all-Range/evidenced-Pair-composition/flat-ordered-Dictionary-scalar-entry subset;
