...
- claim still-unevidenced output contexts or JVM strict stack-frame parity; exact HTML/CSS styling is not a Typst/PDF closure requirement and #398 already owns the bounded source-echo provenance/rendering slice;
...
- close #197 while still-unevidenced output contexts remain;
