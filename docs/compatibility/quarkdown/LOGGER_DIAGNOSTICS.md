...
- claim exact Quarkdown HTML/CSS error-card styling, unevidenced output contexts, or JVM strict stack-frame parity;
...
- close #197 while exact HTML styling/unevidenced output contexts and remaining logger String categories such as Collection remain;
