...
| Quarkdown v2.5.1 theme document-state source | https://raw.githubusercontent.com/iamgio/quarkdown/v2.5.1/quarkdown-stdlib/src/main/kotlin/com/quarkdown/stdlib/Document.kt; https://raw.githubusercontent.com/iamgio/quarkdown/v2.5.1/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/DocumentTheme.kt; https://raw.githubusercontent.com/iamgio/quarkdown/v2.5.1/quarkdown-core/src/main/kotlin/com/quarkdown/core/function/call/binding/RegularArgumentsBinder.kt; https://quarkdown.com/wiki/themes/ | `theme(color: String? = null, @LikelyNamed layout: String? = null)`; both regular parameters bind positionally or by name; `@LikelyNamed` is not a runtime restriction; nullable `NoneValue`; indented body fallback to the final bindable `layout`; lowercase normalization; `VoidValue`; complete `DocumentTheme` replacement; theme existence validation deferred to rendering | 2026-08-24 |
...
| Scribium bounded `.theme` evidence | [independent conformance case](../../../fixtures/quarkdown-conformance/cases/theme-document-state/); `crates/scribium-core/src/lib.rs::tests::theme_*`; `crates/scribium-ir/src/lib.rs::tests::document_theme_component_shapes_roundtrip_without_collapsing_empty_state` | Two positional or named nullable component bindings, `.none`, mixed forms, duplicate/arity failures, bounded final-layout body fallback, scalar conversion, lowercase normalization, whole-state replacement, explicit empty setter, callable sharing, source-defined shadowing, source-backed atomic failures, front-matter separation, deterministic serde, and old-IR theme default | 2026-08-24 |
