...
| Quarkdown v2.5.1 theme document-state source | https://raw.githubusercontent.com/iamgio/quarkdown/v2.5.1/quarkdown-stdlib/src/main/kotlin/com/quarkdown/stdlib/Document.kt; https://raw.githubusercontent.com/iamgio/quarkdown/v2.5.1/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/DocumentTheme.kt; https://quarkdown.com/wiki/themes/ | `theme(color: String? = null, @LikelyNamed layout: String? = null)`; lowercase normalization; `VoidValue`; complete `DocumentTheme` replacement; null components; theme existence validation deferred to rendering | 2026-08-24 |
