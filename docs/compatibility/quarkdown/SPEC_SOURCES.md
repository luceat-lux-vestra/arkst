...
This file records all public specification sources used for Arkst's
...
| Arkst #166 target-conversion implementation evidence | `crates/arkst-engine/src/value_conversion.rs`; `crates/arkst-engine/src/evaluator.rs`; `crates/arkst-markdown/src/parser.rs`; `crates/arkst-ir/src/lib.rs` | Engine-owned bounded target conversion, source-backed raw body retention, dynamic inline Markdown conversion, iterable/dictionary body conversion, and preservation of evaluator-only `ValueOrigin` outside `IrValue` | 2026-08-30 |
| Quarkdown v2.5.1 value/binding/conversion audit | [`VALUE_MODEL_AUDIT.md`](VALUE_MODEL_AUDIT.md) | Canonical #149 matrix and independent Arkst evidence index; no upstream source/test/fixture copied or translated | 2026-08-25 |
...
| Arkst bounded `.dockeywords` evidence | [independent conformance case](../../../fixtures/quarkdown-conformance/cases/dockeywords-family/); `crates/arkst-core/src/lib.rs::tests::dockeywords_*`; `crates/arkst-ir/src/lib.rs::tests::document_state_roundtrips_deterministically_and_defaults_for_old_ir` | Replace semantics, bounded String/Identifier/Number/Boolean element conversion, callable sharing, source-backed atomic failures, ordered IR snapshot, and old-IR keyword defaults | 2026-08-24 |
...
| Quarkdown v2.5.1 regular argument binding evidence | https://raw.githubusercontent.com/iamgio/quarkdown/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/function/call/binding/RegularArgumentsBinder.kt; https://raw.githubusercontent.com/iamgio/quarkdown/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/test/kotlin/com/quarkdown/core/RegularArgumentsBinderTest.kt | Binder-owned positional order, named lookup, positional-then-named mixing, `UnnamedArgumentAfterNamedException` ownership and rejection stage, unknown parameter, excess positional arguments, duplicate positional/named binding, and body fallback to the final bindable parameter; this is the #163 grammar/engine-boundary evidence and does not make named-argument lexical recognition a binder rule; `@LikelyNamed` is not a runtime named-only rule | 2026-08-24 |
| Quarkdown v2.5.1 caption-position tests and docs | https://raw.githubusercontent.com/iamgio/quarkdown/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-test/src/test/kotlin/com/quarkdown/test/CaptionTest.kt; https://raw.githubusercontent.com/iamgio/quarkdown/107ec3a9482f10d6f90d7580f8409b46a719d18e/docs/caption-position.qd | Public caption-position examples and integration coverage for default, per-kind overrides, and `code` caption targets; rendering behavior is upstream evidence but remains outside this Arkst slice | 2026-08-24 |
| Arkst bounded `.captionposition` evidence | [independent conformance case](../../../fixtures/quarkdown-conformance/cases/captionposition-document-state/); `crates/arkst-core/src/lib.rs::tests::captionposition_*`; `crates/arkst-engine/src/value_conversion.rs`; `crates/arkst-ir/src/lib.rs::tests::document_state_roundtrips_deterministically_and_defaults_for_old_ir` | Closed enum conversion, binding failures, repeated merge/preserve behavior, source-backed raw body fallback to `code`, nested rollback, callable sharing, source-defined shadowing, no output, immutable IR snapshot, deterministic serde, and old-IR default compatibility; no caption rendering claim | 2026-08-30 |
| Arkst `.captionposition` raw-body evidence | Pinned [`RegularArgumentsBinder.kt`](https://raw.githubusercontent.com/iamgio/quarkdown/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/function/call/binding/RegularArgumentsBinder.kt), [`FunctionCallRefiner.kt`](https://raw.githubusercontent.com/iamgio/quarkdown/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/parser/FunctionCallRefiner.kt), and current Arkst `CallBody`/IR boundary | Upstream maps an indented `.captionposition` body to the final `codeBlocks` parameter as raw `DynamicValue` text after `trimIndent().trimEnd()`. Arkst retains one shared lossless source buffer and the exact body-token span beside the parsed body, derives that semantic target value only at the engine boundary, and consumes it through the bounded setter without evaluating parsed body nodes; `.html` derives its separate native-content form in its evaluator consumer; caption rendering remains outside this slice | 2026-08-30 |
| Quarkdown v2.5.1 layout/document configuration declarations | https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-stdlib/src/main/kotlin/com/quarkdown/stdlib/Document.kt#L447-L1060; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-stdlib/src/main/kotlin/com/quarkdown/stdlib/Slides.kt#L21-L82 | Exact #153-owned public names, source declarations, aliases, annotations, signatures, defaults, no-output setters, node producers, and document-type constraints | 2026-08-25 |
| Quarkdown v2.5.1 document/layout state models | https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/DocumentInfo.kt#L9-L42; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/DocumentType.kt#L9-L61; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/layout/DocumentLayoutInfo.kt#L9-L37 | Document-wide fields, document-type defaults, layout layer storage, effective page-format grouping, and renderer-default null semantics | 2026-08-25 |
| Quarkdown v2.5.1 font/paragraph/size/page domains | https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/layout/font/FontInfo.kt#L7-L21; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/layout/paragraph/ParagraphStyleInfo.kt#L5-L18; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/layout/page/PageFormatInfo.kt#L10-L66; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/layout/page/PageSizeFormat.kt#L8-L49; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/size/Size.kt#L6-L36 | Closed size/unit, font, paragraph, page size/orientation/side/margin, border, background, column, and selector-layer domains | 2026-08-25 |
| Quarkdown v2.5.1 numbering/TeX/pagination models | https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/numbering/DocumentNumbering.kt#L11-L30; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/numbering/NumberingFormat.kt#L7-L173; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/tex/TexInfo.kt#L3-L8; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/ast/quarkdown/inline/PageCounter.kt#L6-L28; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/context/options/ContextOptions.kt#L9-L56 | Numbering key/format/escape semantics, TeX macro map, page counters, page-break threshold, and ordered pagination events | 2026-08-25 |
| Quarkdown v2.5.1 navigation/TOC/slides models | https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/ast/quarkdown/block/NavigationContainer.kt#L10-L33; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/ast/quarkdown/block/toc/TableOfContentsView.kt#L10-L30; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/ast/quarkdown/invisible/SlidesConfigurationInitializer.kt#L7-L21; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/slides/Transition.kt#L6-L38 | Closed navigation roles, derived TOC/outline state, slides-only configuration, and closed transition style/speed domains | 2026-08-25 |
| Quarkdown v2.5.1 layout/output public tests | https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-test/src/test/kotlin/com/quarkdown/test/DocumentTest.kt; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-test/src/test/kotlin/com/quarkdown/test/PageMarginsTest.kt; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-test/src/test/kotlin/com/quarkdown/test/PageBreakTest.kt; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-test/src/test/kotlin/com/quarkdown/test/NumberingTest.kt; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-test/src/test/kotlin/com/quarkdown/test/CaptionTest.kt; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-test/src/test/kotlin/com/quarkdown/test/TableOfContentsTest.kt; https://github.com/iamgio/quarkdown/blob/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-test/src/test/kotlin/com/quarkdown/test/FontTest.kt | Public behavior evidence for page margins, breaks, numbering, captions, TOC, fonts, and document pipeline effects; tests were evidence only and were not copied | 2026-08-25 |
| Arkst #153 canonical audit | LAYOUT_DOCUMENT_CONFIGURATION_AUDIT.md; LAYOUT_DOCUMENT_CONFIGURATION_AUDIT_MANIFEST.tsv; crates/arkst-core/tests/layout_document_configuration_audit.rs | Independent 47-row inventory, exact target/base checks, ownership/status/provenance invariants, #145/#146 caption revalidation, and state-vs-rendering separation | 2026-08-25 |
...
| Quarkdown v2.5.1 `Document.kt` / `DocumentInfo.kt` | https://raw.githubusercontent.com/iamgio/quarkdown/v2.5.1/quarkdown-stdlib/src/main/kotlin/com/quarkdown/stdlib/Document.kt; https://raw.githubusercontent.com/iamgio/quarkdown/v2.5.1/quarkdown-core/src/main/kotlin/com/quarkdown/core/document/DocumentInfo.kt | `public .doclang(locale: String? = null)` (Kotlin function `docLanguage`); getter returns `locale?.localizedName ?: ""`; successful setter replaces `DocumentInfo.locale`; the pinned JVM `Locale.forLanguageTag` path preserves lenient valid-prefix/root results rather than rejecting malformed syntax; type/arity/binding failures remain invocation errors; successful setter returns `VoidValue`; locale is part of immutable document information | 2026-09-02 |
| Quarkdown v2.5.1 stdlib localization resource and registration hook | https://raw.githubusercontent.com/iamgio/quarkdown/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-stdlib/src/main/kotlin/com/quarkdown/stdlib/Stdlib.kt; https://raw.githubusercontent.com/iamgio/quarkdown/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-stdlib/src/main/resources/lib/localization.qd | `Stdlib` loads `/lib/localization.qd` from `afterRegisteringLibraries` before user calls; the resource invokes `.localization name:{std}` and seeds the standard Chinese, English, French, German, Italian, Japanese, Polish, Portuguese, Russian, and Ukrainian translation entries | 2026-08-25 |
| Quarkdown v2.5.1 locale model and JVM loader | https://raw.githubusercontent.com/iamgio/quarkdown/v2.5.1/quarkdown-core/src/main/kotlin/com/quarkdown/core/localization/Locale.kt; https://raw.githubusercontent.com/iamgio/quarkdown/v2.5.1/quarkdown-core/src/main/kotlin/com/quarkdown/core/localization/LocaleLoader.kt; https://raw.githubusercontent.com/iamgio/quarkdown/v2.5.1/quarkdown-core/src/main/kotlin/com/quarkdown/core/localization/jvm/JVMLocale.kt; https://raw.githubusercontent.com/iamgio/quarkdown/v2.5.1/quarkdown-core/src/main/kotlin/com/quarkdown/core/localization/jvm/JVMLocaleLoader.kt | Observable locale fields: canonical `tag`, language `code`, optional country code, English `displayName`, locale-language `localizedName`; `find` tries case-insensitive English name before `Locale.forLanguageTag`; JVM/system locale data is recorded as upstream behavior only and is not reused by Arkst | 2026-08-24 |
| Quarkdown v2.5.1 `LocaleTest.kt` | https://raw.githubusercontent.com/iamgio/quarkdown/v2.5.1/quarkdown-core/src/test/kotlin/com/quarkdown/core/LocaleTest.kt | Pinned observable examples: `en`/`English` → canonical tag `en`, English name `English`, localized name `English`; `en-US`/`English (United States)` → canonical tag `en-US` and localized name `English (United States)`; `it`/`Italian` → tag `it`, localized name `italiano`; `fr-CA`/`French (Canada)` → tag `fr-CA`, localized name `français (Canada)`; the CJK test directly resolves `ko` (and `zh`/`ja`), establishing `ko` as a reviewed lookup target; case-insensitive name lookup and tag-path fallback follow the pinned JVM behavior, rather than a Arkst parser-validity gate | 2026-09-02 |
| Bounded locale table oracle evidence | https://raw.githubusercontent.com/iamgio/quarkdown/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/localization/jvm/JVMLocale.kt; https://raw.githubusercontent.com/iamgio/quarkdown/107ec3a9482f10d6f90d7580f8409b46a719d18e/quarkdown-core/src/main/kotlin/com/quarkdown/core/localization/jvm/JVMLocaleLoader.kt | Historical evidence-time `java.util.Locale` observations were captured under JDK 25.0.3, following the pinned `JVMLocale` getters. They are historical only and are superseded by the active exact Temurin `25.0.4.1+1` CLDR locale snapshot and public differential gate recorded in `reference-jvm.md`. This oracle remains evidence only; Arkst has no JVM/OS locale dependency. | 2026-08-24 |
...
| Arkst bounded `.doclang` evidence | `crates/arkst-engine/src/locale.rs`; `crates/arkst-core/src/lib.rs::tests::doclang_*`; `crates/arkst-ir/src/lib.rs::tests::document_state_roundtrips_deterministically_and_defaults_for_old_ir`; [independent conformance case](../../../fixtures/quarkdown-conformance/cases/doclang-family/) | Deterministic evidence-backed name-first/tag-second resolution, canonical tag and localized-name snapshot, nullable `.none` getter behavior, positional/named binding and source-backed failures, callable sharing, source-defined shadowing, source-backed body fallback before nested evaluation, atomic rollback, surrounding-content preservation, and old-IR locale default | 2026-08-30 |
...
- The upstream source defines no generic public `.map` or `.filter` in the
  tracked v2.5.1 `Collection.kt`. Arkst retains both as explicit extensions;
...
- `Pair` is observed as two ordered elements. `Dictionary` is observed as an
  ...
  through the shared Arkst materialization policy; right-open and fully-open
  Range values remain representable but standard Iterable consumption rejects
  them as endless.

Arkst routes all operations above, `.foreach`, `.sorted`, and the two
...
Arkst scalar numeric path remains the adaptation boundary for `x` and does
...
Arkst covers this evidence through the shared `bind_arguments` path,
...
`java.lang.Math.*(double)`, then `d2f`. Arkst reproduces that observable
...
than a wrapped integer. Arkst reproduces this boundary behavior with
...
The reviewed `ValueFactory.kt` rules and Arkst boundaries are:
...
- `EvaluableString`, `MarkdownContent`, and `InlineMarkdownContent` require
  evaluation context and parser/lexer participation. Dynamic String →
  InlineMarkdownContent reparsing is implemented only at the explicit
  `.plaintext` target; generic String → Markdown conversion remains
  **context-sensitive conversion deferred**.
- `Size`, `Sizes`, `Color`, enums, and layout/document values are
  **component/layout conversion deferred** because no current approved
  Arkst consumer requires them. Generic collection/callable conversion is
...
Arkst represents that semantic value as `IrValue::Callable`. Its body,
...
Arkst therefore implements `.sorted` only for homogeneous Number, String,
...
NaN ordering is explicit and deterministic in Arkst; the reviewed Quarkdown
...
the Arkst collection-transform slice, not because public `.map`/`.filter`
...
Arkst implements the reviewed boundary with `IrValue::None` and the shared
...
upstream, which is why Arkst explicitly leaves String →
...
Arkst implements only the already-parsed `IrValue::Content` boundary. The
...
## Issue #152 canonical reconciliation

The complete document metadata/document-state inventory, ownership boundary,
status table, mutation model, IR/serde analysis, renderer/front-matter
boundary, and follow-up mapping are canonical in
[`DOCUMENT_STATE_AUDIT.md`](DOCUMENT_STATE_AUDIT.md). Its pinned source
provenance additionally covers `Localization.kt`, `Stdlib.kt`, `Context.kt`,
`ScopeContext.kt`, `SubdocumentContext.kt`, `DocumentTheme.kt`, and the
`FunctionCall` failure path. The machine-checkable
