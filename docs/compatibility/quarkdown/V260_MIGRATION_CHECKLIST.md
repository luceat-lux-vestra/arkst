...
- [ ] `slides` PDF fixes that are observable in Arkst-owned export behavior — classified in #352 as applicable with a current Arkst output divergence; blocked on baseline layout/config/break owners #175/#178/#185, with clean-room evidence and completion criteria documented in `V260_SLIDES_PDF_EXPORT.md`.
