...
| Remaining document-wide layout/configuration (`.numbering`, `.pageformat`, `.font`, page counters, navigation, `.slides`, and related rows) | #153; 8 bounded `PARTIAL` rows and 12 `PARSED_ONLY` rows | #154 component/content consumers; #175–#178 | Numbering/caption/paragraph-style and selected page/slides state have bounded implementations; all residual fields and downstream consumers retain explicit owners and conservative status. |
