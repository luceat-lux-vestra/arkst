...
| [#163](https://github.com/luceat-lux-vestra/scribium/issues/163) | #148 → #149 / grammar representation with engine handoff | Implemented in the grammar/frontend: head and chain segments preserve one source-ordered argument sequence with provenance. Semantic rejection remains #149-owned and is consumed by #165. | Completed in this bounded frontend band; #165 follows. |
