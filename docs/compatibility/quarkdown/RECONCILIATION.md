...
|---|---|
| `PRODUCTION_GAP` | #165–#167, #169, #173–#185, #189, and #197–#199 where the required parser, engine, content, layout, or resource behavior is absent or only bounded. The bounded #195 inspection contract and completed #188 resolver are evidence rather than current owners; #368/PR #371 corrects the #149 Unit value-model omission, while #197 now has the clean-room-evidenced Unit/None/closed-Range/plain-text-Pair logger String subset, native `arkst build` stdout wiring, bounded default/non-strict `.error` stderr/rendered continuation, and bounded strict host finalization with exit 66/no-artifact/first-error stderr, and remains open for unreviewed logger String categories plus exact-styling/unevidenced-output residuals; public WASM/embedder exposure remains #191. |
