...
```text
  ...
  #165/#166/#167 ──► #194 dictionary, #196 localization
       ...
       #197 logger: bounded evaluator/sink + Unit + evidenced String subset + native build stdout + default/non-strict `.error` output + strict host finalization implemented; styling/unevidenced-output, analysis-command, and unreviewed String residuals stay #197, public WASM/embedder exposure stays #191 (#190 complete)
